...
export default function AllTransactions({ amountBlocked }: Props) {
  ...
  const onCanceledRequest = (item: any) => {
    ...
    if (item.request?.type === "Charge") {
      ...
      swalWithBootstrapButtons
        .fire({
          title: "Are you sure?",
          text: `Are you sure you want to cancel your transfer request?`,
          icon: "warning",
          showCancelButton: true,
          confirmButtonText: "Yes, I want to cancel!",
          cancelButtonText: "No, I want to keep it!",
        ...
        .then(async (result) => {
          if (result.isConfirmed) {
            ...
            swalWithBootstrapButtons.fire(
              "Confirmed!",
              "You have cancelled your transfer request. You can make a new one from your wallet.",
              "success"
            );
          } else if (
            /* Read more about handling dismissals below */
